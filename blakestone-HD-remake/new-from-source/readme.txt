Currently, these have a pink/purple background, which i need to remove.

i'm trying to use the source images with more detailed prompts, based on what i think the image is.
I'm doing tons of seeds and changing lots of settings to try to get images similar.
...
Model: z-image
seed: 102970954659458
seed has to change sometimes to get the right output.
