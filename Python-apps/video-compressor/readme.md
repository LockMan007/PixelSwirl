Previous version, without the pop-up disable option:
video_compressor3-2025-10-29-backup.py

6/19/2026 update:
Added "Remove Meta Data" button, as an optional button if that is all you want to do.
